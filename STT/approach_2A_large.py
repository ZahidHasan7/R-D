"""
approach_2A_large.py — Step 2A: Large Model Inference (Whisper large-v3)
========================================================================
Run Whisper large-v3 on the scenario audio files.
"""
...
print("Loading Whisper 'large-v3' model... (This will download ~1.5GB if not cached)")
...
print(f"\nProcessing {len(scenarios)} scenarios with large-v3...")
...
# ── Report ──────────────────────────────────────────────────────
print("\n" + "="*60)
print("WHISPER LARGE-V3 RESULTS (2A)")
print("="*60)
